...
export default function SongItem({item}){
    ...
    return(
        ...
        className={`w-11 h-11 transition-play duration-200 ease-in rounded-full text-black bg-primary opacity-0
        absolute flex bottom-0 right-2 items-center justify-center group-hover:opacity-100
        group-hover:bottom-2 hover:scale-105 hover:bg-highlight`}>
